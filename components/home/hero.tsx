    ...
    <section className="min-h-[calc(100vh-64px)] flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="container z-10 px-4 mx-auto">
        ...
        >
          ...
          >
            <Link
              aria-label="Programează o consultanță pentru dezvoltare website"
              className="w-full sm:w-auto"
              href="https://calendly.com/petrecirceag/consultanta-dezvoltare-website"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button
                fullWidth
                aria-label="Programeaza o intalnire"
                color="primary"
