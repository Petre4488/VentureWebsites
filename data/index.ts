export const DATA = {
  home: {
    hero: {
      name: "Venturely",
      title: "Site-uri în 24h + automatizări inteligente",
      subtitle:
        "Lansăm site-ul tău în 24 de ore, de la €300. Domeniu gratuit + găzduire gratuită primul an. Nu facem site‑uri WordPress — folosim tehnologii moderne.",
    },
    skills: {
      sectionTitle: "Abilități & Expertiză",
      sectionDescription:
        " Specializați în creare site rapid (24h), automatizări AI & booking, SEO și analytics. Nu facem WordPress — folosim tehnologii moderne.",
      overview: [
        {
        ...
        {
          name: "Performanță & Accesibilitate",
          level: 88,
          icon: "lucide:video",
          color: "warning",
        },
    ...
    testimonials: {
      sectionTitle: "Testimoniale clienți",
      sectionDescription: "Căutăm studii de caz — înscrie-te pentru un pilot (clinici & educație).",
      items: [
        {
          id: 1,
          name: "Sarah Johnson",
  ...
  about: {
    profile: {
      ...
      description: [
        ...
        "Oferta: domeniu gratuit (dacă e sub 10$) + găzduire gratuită în primul an, chatbot AI, programări online, formulare către CRM/Sheets și trackere GA4/Meta.",
      ],
    },
    education: [
      {
...
},
{
  ...
  description:
    ...
    experience: [
      ...
      },
      {
        ...
        date: "Framer • React • TypeScript • Tailwind",
        icon: "mdi:monitor-dashboard",
        description:
          "Hosting Framer + DNS setup inclus. Integrare GA4 (evenimente formular/CTA), WhatsApp click‑to‑chat, Calendly/TidyCal. Opțional: Stripe/Revolut/Netopia, MailerLite, HubSpot/Sheets/Notion.",
      },
      {
        title: "Ce NU e în 24h",
        date: "Out of Scope",
        icon: "mdi:code-tags",
        description:
          "Backend complex, copywriting avansat, multi‑language, >5 pagini, logo/branding de la zero, automatizări complicate — trec în pachetele Grow/Scale.",
      },
    ],
    technologies: {
      frontend: {
        description:
          "UI responsive în Framer/React, cu componente curate și animații moderne.",
        tools: [
      ...
      backend: {
        description:
          "APIs & webhooks ușoare când este nevoie (formulare, CRM, plăți).",
        tools: [
      ...
      uiUx: {
        description:
          "Design centrat pe utilizator pentru clinici, terapeuți, tutori și IMM‑uri.",
        tools: [
      ...
      graphicDesign: {
        description:
          "Kit-uri de brand și materiale vizuale pentru conversie (la cerere).",
        tools: [
      ...
      motionDesign: {
        description:
          "Micro‑interacțiuni premium care nu încetinesc paginile.",
        tools: [
  ...
  projects: {
    sectionTitle: "Proiecte",
    sectionDescription:
      "Website‑uri și template‑uri pentru educație și sănătate (site clinici, site psihologi, site școli/cursuri) — optimizate pentru viteză, SEO și conversii.",
    work: [
      {
        id: 1,
  ...
  contact: {
    heading:
      "Ai un proiect? Programează un call de 15 minute sau cere un homepage mockup gratuit.",
      location: {
      mapSrc: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1444222.694!2d24.5!3d45.9!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40ad4b7b0b0!2sRomania!5e0!3m2!1sen!2sro!4v1715701234567!5m2!1sen!2sro",
      address: "România",
    },
  },
  morphingTexts: {
  ...
  footer: {
    name: "Venturely",
    description: "Site‑uri gata mâine. 24h. Domeniu gratuit (<10$) + găzduire gratuită în primul an.",
    contact: {
      email: "hello@venturely.online",
      phone: "+40 753 989 970",
      location: "România",
    },
    socialLinks: [
    ...
    services: ["Creare site 24h", "Automatizări AI & Booking", "SEO & Analytics", "Mentenanță"],
  },
} as const;
